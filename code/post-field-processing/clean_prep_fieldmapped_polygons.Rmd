...
today <- "4_4_25" #a string containing the date of run
...
sf::st_write(uasPoly_raw, here::here('data/derived/test_raw_uas_from_arc.gpkg'))
...
bear_uas_raw <- access_data_get_x_from_arcgis_rest_api_geojson(base_url = bear_uas_polys_url,
                                                                   ...
                                                                   n = "all",
                                                                   timeout = 500)
sf::st_write(bear_uas_raw |> select(-FID), here::here('data/derived/test_raw_uas_beartooth_from_arc.gpkg'))
